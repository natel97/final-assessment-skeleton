			...
			result.stream().forEach(level2 -> {
				...
				result.stream().forEach(level3 -> {
					...
					result.stream().forEach(level4 -> {
						if(!level3.getDestination().equals(level4.getOrigin()) || level1.getDestination().equals(level4.getDestination()) || level2.getDestination().equals(level4.getDestination()) || level4.getOffset() < (level3.getFlightTime() + level3.getOffset() + 1) || level1.getOrigin().equals(level4.getDestination()))
							return;
